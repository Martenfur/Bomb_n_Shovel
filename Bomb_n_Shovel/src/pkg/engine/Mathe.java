...
public class Mathe
{
	...
	//Diagonal.
	public static final int rotated_x[] =
	{
		1, -1, -1, 1
	};
	public static final int rotated_y[] =
	{
		-1, -1, 1, 1
	};
	...
	//MATH/////////////////////////////////////////////////////////////////////////////
	/**
	 * Works just like regular sign, but in case of 0 returns 1.
	 */
	...
	/**
	 * Sets seed based on current time. !!!EITHER THIS OR randomSetSeed() MUST BE
	 * CALLED BEFORE USING ANY OF OTHER RANDOM FUNCTIONS!!!
	 */
	...
	/**
	 * Sets seed manually. !!!EITHER THIS OR randomize() MUST BE CALLED BEFORE
	 * USING ANY OF OTHER RANDOM FUNCTIONS!!!
	 *
	 * @param seed Seed.
	 */
